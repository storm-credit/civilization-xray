...
| Sydney Opera House iconic-landmark routing | **PASS / HYBRID ROUTING REAFFIRMED** | `SYDNEY_OPERA_HOUSE_TOOL_ROUTING_BENCHMARK_2026_08_22.md` | real/verified identity + Blender explanatory truth + selective generative context; no topology change |
